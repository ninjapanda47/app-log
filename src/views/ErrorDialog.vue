  ...
  <div class="text-center">
    <v-dialog v-model="applicationStore.hasError">
      <v-card class="text-center">
        <v-card-title class="text-h5 font-weight-bold">{{ applicationStore.apiError.error }}</v-card-title>
        ...
        <v-card-actions>
          <v-btn color="primary" block @click="applicationStore.clearApiError">Close</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
  </div>
